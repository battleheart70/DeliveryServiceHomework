...
class DeliveryServiceTest {
  ...
  @CsvSource({
    ...
    "VERY_HIGH, 35, LARGE, false, SAME_DAY, 1280", // Максимальная доплата за расстояние (>30 км) и
                                                   // хрупкость запрещена
    ...
    "NORMAL, 1.9, LARGE, false, STANDARD, 400", // Граничное значение (2 км → 1.9 км → 50 руб.) +
                                                // сумма ниже минимума
